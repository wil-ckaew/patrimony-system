...
export default function RegisterScreen({ navigation }) {
  ...
  const handleRegister = async () => {
    if (!formData.company_name || !formData.department || !formData.username || !formData.password) {
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
      ...
      >
        ...
        <View style={styles.form}>
          <Text style={styles.label}>Empresa/Órgão *</Text>
          <TextInput
            style={styles.input}
          ...
          <TextInput
            ...
            placeholder="Educação, Saúde, Administração..."
            editable={!loading}
          />
          ...
          >
            <Text style={styles.loginText}>
              Já tem uma conta? <Text style={styles.loginBold}>Fazer login</Text>
            </Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
